...
class UserPreferenceClassifier:
    ...
    def prepare_features(self, df: pd.DataFrame) -> Tuple[pd.DataFrame, pd.Series]:
        ...
        print("[FEATURES] Preparando features per user classification...")
        ...
        print(f"   Features generate: {len(self.feature_names)}")
        print(f"   Shape dataset: {features.shape}")
        print(f"   Distribuzione target: {target.value_counts().to_dict()}")
        
        return features, target
    
    def train_models(self, X: pd.DataFrame, y: pd.Series) -> Dict[str, Dict]:
        """
        Training e valutazione classificatori multi-class
        ...
        print("[TRAINING] Training user preference classifiers...")
        ...
        for model_name, model in self.models.items():
            ...
            # Cross-validation (requirement ICon: multiple runs)
        ...
        print(f"\n[BEST MODEL] {best_model_name} con accuracy = {results[best_model_name]['test_accuracy']:.3f}")
    ...
    def explain_prediction(self, user_profile: str, probabilities: Dict[str, float]) -> str:
        ...
        CONCETTO ICon: Explainable AI per trasparenza sistema
        """
    ...
    def save_model(self, filepath: str):
        ...
        print(f"[SAVED] Classificatore salvato in: {filepath}")
    ...
    def load_model(self, filepath: str):
        ...
        self.is_trained = True
        print(f"[LOADED] Classificatore caricato da: {filepath}")
