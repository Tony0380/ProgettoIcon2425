#!/usr/bin/env python3
"""
Intelligent Travel Planner - ICon 2024/25

Sistema di pianificazione viaggi che integra tutti i paradigmi ICon:
...
class IntelligentTravelPlanner:
    ...
    def __init__(self, 
        ...
        if self.verbose:
            print("=" * 80)
            print("INTELLIGENT TRAVEL PLANNER - ICon 2024/25")
            print("=" * 80)
    ...
    def _initialize_components(self):
        ...
        if self.verbose:
            print(f"   ✅ Graph loaded with {len(self.city_graph.cities)} cities")
            print(f"   ✅ {self.city_graph.graph.number_of_edges()} connections available")
        ...
        if self.verbose:
            print(f"   ✅ Bayesian Network with {len(self.bayesian_net.nodes)} nodes")
    ...
    def plan_travel(self,
        ...
        if self.verbose:
            print(f"\n✅ Travel planning completed in {computation_time:.2f}s")
    ...
    def run_comprehensive_evaluation(self) -> Dict[str, Any]:
        """
        Esegue valutazione completa del sistema per ICon
        
        Returns:
            Risultati completi con metriche ICon-compliant
        """
        ...
        for i, scenario in enumerate(demo_scenarios, 1):
            ...
            try:
                ...
                if result['recommendations']['primary']['route']:
                    ...
                    print(f"✅ Route found: {' → '.join(route['path'])}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Intelligent Travel Planner - ICon 2024/25",
  ...
  python intelligent_travel_planner.py --plan venezia napoli --profile business --budget 300
    ...
    try:
        ...
        if args.demo:
            ...
            if result['recommendations']['primary']['route']:
                route = result['recommendations']['primary']['route']
                print(f"✅ Recommended Route: {' → '.join(route['path'])}")
                ...
                print("❌ No suitable route found for your criteria")
