...
class ComprehensiveEvaluationFramework:
    ...
    def __init__(self):
        print("=" * 80)
        print("COMPREHENSIVE EVALUATION FRAMEWORK - ICon 2024/25")
        print("=" * 80)
    ...
    def generate_results_tables(self) -> Dict[str, pd.DataFrame]:
        """
        Genera tabelle risultati in formato professionale per ICon
    ...
    def print_summary_report(self):
        ...
        print(f"• ICon requirements: FULLY SATISFIED ✅")
        print(f"{'='*80}")
