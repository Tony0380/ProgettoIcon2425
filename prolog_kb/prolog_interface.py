...
class PrologKnowledgeBase:
    ...
    def explain_constraints(self, 
        ...
        CONCETTO ICon: Explainable AI con ragionamento simbolico
        """
        ...
        if validation['valid']:
            explanation += "✅ VIAGGIO VALIDO - Tutti i vincoli soddisfatti:\n"
            for constraint in validation['constraints_satisfied']:
                explanation += f"  • {constraint}\n"
        else:
            explanation += "❌ VIAGGIO NON VALIDO - Vincoli violati:\n"
